...
import { FaReact, FaNodeJs, FaGitAlt, FaDocker, FaPython, FaJava, FaDatabase } from 'react-icons/fa';
import { SiMongodb, SiExpress, SiThreedotjs, SiTypescript, SiJavascript, SiNextdotjs, SiTailwindcss, SiRedux } from 'react-icons/si';
...
const SkillCard = ({ position, skill }: { position: [number, number, number], skill: Skill }) => {
